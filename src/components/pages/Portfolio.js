      ...
      <Container style={{ marginTop: 30 }}>
        ...
        <Row>
            ...
            <Col size="md-6">
                <Card>
                  <a href="../homework6-weatherDashboard/index.html"></a>
                  <img src="./assets/images/burger.jpeg" alt="Cell Phone Image" width="300" height="300"></img>
        ...
        <Row>
            <Col size="md-6">
                <Card>
                  ...
                  <img src="./assets/images/Hiking.jpg"  alt="Hiking Image" width="300" height="300"></img>
            ...
            <Col size="md-6">
                <Card>
                  ...
                  <img src="../homework2-bootstrap/assets/images/rutgerscellphone.jpeg" alt="Cell Phone Image" width="300" height="300"></img>
        ...
        <Row>
          <Card>
            ...
            <img src="./assets/images/cli.jpg"  alt="CLI Image" width="300" height="300"></img>
